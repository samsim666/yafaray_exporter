...
bl_info = {
    ...
    "author": "Shuvro Sarker, Kim Skoglund (Kerbox), Pedro Alcaide (povmaniaco), Paulo Gomes (tuga3d), Michele Castigliego (subcomandante), Bert Bucholtz, Rodrigo Placencia (DarkTide), Alexander Smirnov (Exvion)",
    "version": (0, 1, 2, 'alpha'),
    "blender": (2, 5, 6),
